...
const projects = [
  {
    title: "Launch It",
    description:
      "Launch It is a startup discovery and networking platform that helps founders showcase their products, attract users, and grow faster.",
  ...
  },
  {
    title: "CCBOND",
    description:
      "CCBOND is a comprehensive B2B networking platform that facilitates business connections, lead generation, and communication between companies through enquiries, sales opportunities, and product listings.",
  ...
  },
  {
    ...
    description:
      "A user-centric mobile application that enhances road safety through real-time pothole alerts and crowdsourced hazard reporting.",
  ...
  },
  {
    ...
    description:
      "A deep learning app that recognizes human emotions using facial expressions.",
...
const Projects = () => {
  return (
    <section id="projects" className="py-12 px-4 w-full bg-black text-white">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map((tech, i) => (
                    <span
                      key={i}
                      className="bg-[#232323] text-xs px-3 py-1 rounded-full border border-gray-700"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="mt-2">
                {project.live ? (
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-black font-semibold rounded-lg bg-white px-5 py-2 hover:bg-black hover:text-white border border-white transition"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 text-gray-300 font-semibold rounded-lg bg-gray-600 px-5 py-2 cursor-not-allowed"
                  >
